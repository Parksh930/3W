   ...
   $('a').click(function(){
      var check = $(this).attr("id");
         if(check == 'calendar'){
            ...
            document.getElementById("mapplusbtn").style.visibility = "hidden";
         }
         else{
                  ...
                  <table>
                     <div class="social-icons">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger"
                           href="calendar" target="box2" id="calendar" onclick="buttonHide()">
                              <div id="iconimg">
                        ...
                        <!-- 날씨 -->
                        <li class="nav-item"><a class="nav-link js-scroll-trigger"
                           href="weather" target="box2" id="weather" onclick="buttonShow()" >
                              <div id="iconimg">
                        ...
                        <!-- 뉴스 -->
                        <li class="nav-item"><a class="nav-link js-scroll-trigger"
                           href="news" target="box2" id="news" onclick="buttonShow()">
                              <div id="iconimg">
